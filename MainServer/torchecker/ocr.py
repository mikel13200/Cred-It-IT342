...
def process_images(images, account_id=None):
    """
    Loop through uploaded images (in order), run OCR, and return structured results.
    """
    reader = easyocr.Reader(['en'])
    all_results = []

    for image in images:  # <-- ensures first to last order
